globalThis.monorepoPackagePath = "";globalThis.openNextDebug = false;globalThis.openNextVersion = "3.6.0";
...
var PrerenderManifest = { "version": 4, "routes": { "/contacto": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/contacto", "dataRoute": "/contacto.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": 600, "initialExpireSeconds": 31536e3, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/articulos": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/articulos", "dataRoute": "/articulos.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": { "/articulos/[slug]": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "routeRegex": "^/articulos/([^/]+?)(?:/)?$", "dataRoute": "/articulos/[slug].rsc", "fallback": null, "dataRouteRegex": "^/articulos/([^/]+?)\\.rsc$", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "notFoundRoutes": [], "preview": { "previewModeId": "e76870c6c16f53e1fca58b0027eb9f5e", "previewModeSigningKey": "396358c9f9bdf71623499641a6f26ab50429604fabd40b1418c4e1e4a5b799f4", "previewModeEncryptionKey": "e620019cefdecf313064f54a4470eb9d4564e9eb4c58d8c2ff341275e687a5ee" } };
var MiddlewareManifest = { "version": 3, "middleware": {}, "functions": {}, "sortedMiddleware": [] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/(frontend)/(sitemaps)/articulos-sitemap.xml/route": "/articulos-sitemap.xml", "/(frontend)/next/exit-preview/route": "/next/exit-preview", "/(frontend)/next/preview/route": "/next/preview", "/(payload)/api/[...slug]/route": "/api/[...slug]", "/(payload)/api/graphql-playground/route": "/api/graphql-playground", "/(payload)/api/graphql/route": "/api/graphql", "/(payload)/admin/[[...segments]]/page": "/admin/[[...segments]]", "/(frontend)/articulos/page": "/articulos", "/(frontend)/contacto/page": "/contacto", "/(frontend)/search/page": "/search", "/(frontend)/articulos/[slug]/page": "/articulos/[slug]", "/(frontend)/page": "/" };
